...
// NEW ADD
import { addItem } from './CartSlice';  // Import CartSlice reducer
...
function ProductList() {
    ...
    const handleAddToCart = (plant) => {
        ...
        // Assuming addItem is imported from CartSlice.jsx
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <span style={{ color: 'white', fontSize: '20px', position: 'absolute', top: '32px', right: '33px', borderRadius: '50%', padding: '5px 10px' }}>
                                    {totalCartQuantity}
                                </span>
                            </h1>
                        </a>
